...
import io.openems.edge.battery.audibatcon.enums.Balancing;
import io.openems.edge.battery.audibatcon.enums.BalancingMessage;
import io.openems.edge.battery.audibatcon.enums.BalancingStatus;
import io.openems.edge.battery.audibatcon.enums.BatconReset;
import io.openems.edge.battery.audibatcon.enums.BatteryReset;
import io.openems.edge.battery.audibatcon.enums.BatteryType;
import io.openems.edge.battery.audibatcon.enums.BusError;
import io.openems.edge.battery.audibatcon.enums.CanState;
import io.openems.edge.battery.audibatcon.enums.CellDifferenceStatus;
import io.openems.edge.battery.audibatcon.enums.ContactorCommand;
import io.openems.edge.battery.audibatcon.enums.DcCharge;
import io.openems.edge.battery.audibatcon.enums.FailureMemoryDelete;
import io.openems.edge.battery.audibatcon.enums.FailureMemoryDeleteStatus;
import io.openems.edge.battery.audibatcon.enums.FailureMemoryRead;
import io.openems.edge.battery.audibatcon.enums.FailureMemoryReadStatus;
import io.openems.edge.battery.audibatcon.enums.IsolationMearsurementDeactivationModeRead;
import io.openems.edge.battery.audibatcon.enums.IsolationMearsurementDeactivationModeWrite;
import io.openems.edge.battery.audibatcon.enums.IsolationResistanceStatus;
...
import io.openems.edge.battery.audibatcon.enums.ResetUserNetworkAddress;
import io.openems.edge.battery.audibatcon.enums.StatusKL15Can;
...
public interface AudiBatcon extends Battery, OpenemsComponent, StartStoppable {
	...
	public enum ChannelId implements io.openems.edge.common.channel.ChannelId {
		...
		POWER_DERATING(Doc.of(Level.FAULT) //
	...
	public default StateChannel getErrorBatteryTypeChannel() {
		return this.channel(AudiBatcon.ChannelId.ERROR_BATTERY_TYPE);
	}
